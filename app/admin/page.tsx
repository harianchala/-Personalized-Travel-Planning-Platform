...
import { BarChart3, Users, MapPin, Hotel, TrendingUp, DollarSign, Calendar, Star } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Total Revenue", value: "$89,432", change: "+15%", icon: DollarSign, color: "text-purple-600" },
  ...
  const topDestinations = [
    { name: "Paris, France", bookings: 234, revenue: "$45,600" },
    { name: "Tokyo, Japan", bookings: 189, revenue: "$38,200" },
    { name: "Bali, Indonesia", bookings: 156, revenue: "$28,900" },
    { name: "New York, USA", bookings: 143, revenue: "$52,100" },
  ]
